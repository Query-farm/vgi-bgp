#!/usr/bin/env bash
# Build the browser (`worker:`) build of the bgp VGI worker: bgp-wasm compiled to
...
LIB="target/$TARGET/release/libbgp_wasm.a"
...
# native. STACK_SIZE / DEFAULT_PTHREAD_STACK_SIZE: emscripten's 64 KiB default
# stack overflows here (object_store + tokio + Arrow encoders nest deeply), and
# an overflow surfaces as a bare "memory access out of bounds". INITIAL_MEMORY
